...
int findAndDiscard(struct gameState *state, int currentPlayer, int choice1, int number)
{
    int i;
    ...
    for (i = 0; i < state->handCount[currentPlayer]; i++)
        {
            ...
            {
                discardCard(i, currentPlayer, state, number);
                break;
            }
        }
...
int draw4(int player, struct gameState *state)
{
    for (int i = 0; i < 4; i++)
        {
...
int ambassadorEffect(int handPos, int choice1, int choice2, int currentPlayer, struct gameState *state)
{
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case ambassador:
       ambassadorEffect(handPos, choice1, choice2, currentPlayer, state);
